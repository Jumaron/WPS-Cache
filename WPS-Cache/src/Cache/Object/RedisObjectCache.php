 ...
 */
final class RedisObjectCache extends AbstractFilesystemModule implements Module, Purgeable
{
    ...
    public function __construct(
        ...
        if (defined("WP_REDIS_SIGNING_KEY")) {
            ...
            // Sentinel Enhancement: Removed volatile filesystem metrics (mtime/inode) to prevent
            // unintended cache invalidation on plugin updates or container redeployments.
            // The combination of DB credentials and path is sufficient for site-specific entropy.
    ...
    private function connect(): void
    {
        ...
        // 6. Capability checks cached once after connecting.
        $this->useUnlink = is_string($redisVersion)
            && version_compare($redisVersion, '4.0.0', '>=');
        $this->useAsyncFlush = $this->useUnlink;
    }
